...
namespace Project1 {
    ...
    class Rectangle2 : Square2 {
        ...
        public Rectangle2 (int width, int length) : base (width, length) {
            this.width = width;
            this.length = length;
        }
    ...
    class RectangleAreaTest {
        ...
        public void testRectangleArea () {
            ...
            var rectangle = new Rectangle2 (150, 50);
        ...
        class SquareAreaTest {
            ...
            class RectangleAreaExceptionTest {
                ...
                public void testRectangleAreaException () {
                    ...
                    var rectangle = new Rectangle2 (50, 50);
