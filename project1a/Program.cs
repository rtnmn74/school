...
namespace Project1 {
    ...
    class Square1 : Rectangle1 {
        ...
        /* Routine to default value for all sides based on last value input*/
    ...
    class SquareAreaValueNotEqualTest {
        [Test]
        public void testSquareArea () {
            /* Given a new square with a width of 51 and a length of 50, compute the area using second input value as the default value*/
            var square = new Square1 ();
            square.Width = 51;
            square.Length = 50;
            var result = square.computeArea ();
    ...
    class SquarePerimeterValueNotEqualTest {
        [Test]
        public void testSquarePerimeter () {
            /* Given new square with a width of 50 and a length of 51, compute the perimeter using second input value as the default value*/
            var square = new Square1 ();
            square.Width = 50;
            square.Length = 51;
            var result = square.computePerimeter ();
